...
import { UpdateUserSettingsRequest, UserSettings } from '../../../core/models/settings.models';
...
export class AccountSettingsStore {
  ...
  private errorMessage(error: unknown): string {
    return error instanceof HttpErrorResponse ? (error.error as Partial<ApiResponse<unknown>> | null)?.message || 'Unable to update settings.' : 'Unable to update settings.';
  }
}
